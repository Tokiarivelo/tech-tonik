...
import { ReactionUncheckedCreateNestedManyWithoutPageInput } from '../reaction/reaction-unchecked-create-nested-many-without-page.input';
...
export class ExitPageUncheckedCreateInput {
    ...
    reactions?: ReactionUncheckedCreateNestedManyWithoutPageInput;
