...
import { PageViewUncheckedUpdateManyWithoutPageNestedInput } from '../page-view/page-view-unchecked-update-many-without-page-nested.input';
...
export class ExitPageUncheckedUpdateWithoutCommentsInput {
    ...
    views?: PageViewUncheckedUpdateManyWithoutPageNestedInput;
